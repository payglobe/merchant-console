...
//CONNECT TO DATABASE NAMED lifeDB WITH MYSQL WITH ROOT USER AND EMPTY PASSWORD
	...
	$query = "SELECT count(*) AS count, date(dataOperazione) AS dataOperazione FROM tracciatoes GROUP BY date( dataOperazione) ORDER BY date(dataOperazione) DESC  limit 7 ";
