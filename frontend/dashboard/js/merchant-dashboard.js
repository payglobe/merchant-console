    ...
    return {
        ...
        async login() {
            ...
            try {
                ...
                console.log('✅ Step 1: Dates configured', { startDate: this.filters.startDate, endDate: this.filters.endDate, daysBack });

                // Set authenticated and load data directly (no page reload needed)
                this.isAuthenticated = true;
                console.log('✅ Step 2: isAuthenticated set to true');

                // Wait for Alpine to update DOM, then load data
                console.log('✅ Step 3: Calling $nextTick...');
                this.$nextTick(() => {
                    console.log('✅ Step 4: Inside $nextTick, setting timeout...');
                    setTimeout(() => {
                        console.log('✅ Step 5: Inside timeout, loading data...');
                        try {
                            lucide.createIcons();
                            console.log('✅ Step 6: Icons created, loading stores...');
                            this.loadStores();
                            console.log('✅ Step 7: Stores loading, loading all data...');
                            this.loadAllData();
                            console.log('✅ Step 8: All data loading started!');
                        } catch (err) {
